...
class Profile(models.Model):  
    ...
    picture = models.ImageField(default='users/users_default_profile.png', upload_to=user_directory_path_profile)
    banner = models.ImageField(default='users/users_default_bg.jpg', upload_to=user_directory_path_banner)
